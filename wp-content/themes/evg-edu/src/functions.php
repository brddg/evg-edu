...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('recent-post', 390, 308, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
?>
    ...
    <div <?php comment_class(empty( $args['has_children'] ) ? 'media' : 'media parent') ?> id="comment-<?php comment_ID() ?>">
      ...
      <div class="media-body"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>">
